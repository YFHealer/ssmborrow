...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="layout_left_menu">
            <ul id="menu">
                <li class="childUlLi">
                    <a href="#"  target="menuFrame"><i class="glyph-icon icon-home"></i>借阅管理</a>
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/borrow/listByPage.action" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>显示全部记录</a>
                        </li>
                                
                                <li><a href="${pageContext.request.contextPath}/borrowKind/list.action" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>显示书籍分类</a>
                        </li>
